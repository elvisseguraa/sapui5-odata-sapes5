		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Demo",
									"targetURL": "#comesegurapedemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comesegurapedemo-display": {
								"semanticObject": "comesegurapedemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.esegura.pe.demo",
									"url": sap.ui.require.toUrl("com/esegura/pe/demo")
								}
							}
						}
					}
